...
public class QueryValidationTest {
  ...
  public void testNonExistingColumns() {
    ...
    testNonExistingColumns("foo", false, Collections.singletonMap("col1", "col1"), query,
        "Unknown columnName 'col2' found in the query");
    testNonExistingColumns("foo", false, Collections.singletonMap("col2", "col2"), query,
        "Unknown columnName 'col1' found in the query");
    testExistingColumns("foo", false, Collections.singletonMap("col2", "col2", "col1", "col1"), query);
    query = "SELECT sum(Col1) FROM foo";
    testNonExistingColumns("foo", false, Collections.singletonMap("col1", "col1"), query,
        "Unknown columnName 'Col1' found in the query");
    testExistingColumns("foo", false, Collections.singletonMap("Col1", "Col1"), query);
    testExistingColumns("foo", true, Collections.singletonMap("col1", "col1"), query);
    testExistingColumns("foo", true, Collections.singletonMap("col1", "Col1"), query);
    ...
    testNonExistingColumns("foo", false, Collections.singletonMap("col1", "col1", "b", "b", "c", "c"), query,
        "Unknown columnName 'Col1' found in the query");
    testNonExistingColumns("foo", false, Collections.singletonMap("Col1", "Col1", "B", "B", "c", "c"), query,
        "Unknown columnName 'b' found in the query");
    testNonExistingColumns("foo", false, Collections.singletonMap("Col1", "Col1", "c", "c"), query,
        "Unknown columnName 'b' found in the query");
    testNonExistingColumns("foo", false, Collections.singletonMap("Col1", "Col1", "b", "b", "C", "C"), query,
        "Unknown columnName 'c' found in the query");
    testExistingColumns("foo", false, Collections.singletonMap("Col1", "Col1", "b", "b", "c", "c"), query);
    testExistingColumns("foo", true, Collections.singletonMap("col1", "col1", "b", "b", "c", "c"), query);
    testExistingColumns("foo", true, Collections.singletonMap("col1", "COL1", "b", "B", "c", "C"), query);
    query = "SELECT sum(Col1) AS sum_col1, b AS B, c as D FROM foo GROUP BY 2, 3";
    testNonExistingColumns("foo", false, Collections.singletonMap("col1", "col1", "B", "B", "c", "c", "D", "D"), query,
        "Unknown columnName 'Col1' found in the query");
    testNonExistingColumns("foo", false, Collections.singletonMap("col1", "col1", "b", "b", "c", "c"), query,
        "Unknown columnName 'Col1' found in the query");
    testNonExistingColumns("foo", false, Collections.singletonMap("Col1", "Col1", "B", "B", "c", "c"), query,
    ...
    testNonExistingColumns("foo", false, Collections.singletonMap("Col1", "Col1", "b", "b", "C", "C"), query,
        "Unknown columnName 'c' found in the query");
    testExistingColumns("foo", false, Collections.singletonMap("Col1", "Col1", "b", "b", "c", "c", "D", "D"), query);
    testExistingColumns("foo", true, Collections.singletonMap("col1", "col1", "b", "b", "c", "c", "d", "d"), query);
    testExistingColumns("foo", true, Collections.singletonMap("col1", "COL1", "b", "B", "c", "C"), query);
  }

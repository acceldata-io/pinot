...
public class DefaultColumnHandlerTest {
  ...
  public void testComputeDefaultColumnActionMap()
    ...
    try (SegmentDirectory segmentDirectory = new SegmentLocalFSDirectory(INDEX_DIR, ReadMode.mmap);
      ...
      // Same schema
      testComputeDefaultColumnActionMap(new HashMap<>());

      // Add single-value dimension in the schema
      _schema.addField(new DimensionFieldSpec("column11", DataType.INT, true));
      testComputeDefaultColumnActionMap(Collections.singletonMap("column11", DefaultColumnAction.ADD_DIMENSION));
      ...
      testComputeDefaultColumnActionMap(Collections.singletonMap("column11", DefaultColumnAction.ADD_METRIC));
      _schema.removeField("column11");

      // Add date-time in the schema
      _schema.addField(new DateTimeFieldSpec("column11", DataType.INT, "EPOCH|HOURS", "1:HOURS"));
      testComputeDefaultColumnActionMap(Collections.singletonMap("column11", DefaultColumnAction.ADD_DATE_TIME));
      _schema.removeField("column11");

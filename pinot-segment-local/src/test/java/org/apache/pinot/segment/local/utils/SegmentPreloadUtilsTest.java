...
public class SegmentPreloadUtilsTest {
  ...
  public void testPreloadSegments()
    ...
    segmentAssignment.put("consuming_seg01", Collections.singletonMap(instanceId, "CONSUMING"));
    segmentAssignment.put("consuming_seg02", Collections.singletonMap(instanceId, "CONSUMING"));
    segmentAssignment.put("offline_seg01", Collections.singletonMap(instanceId, "OFFLINE"));
    segmentAssignment.put("offline_seg02", Collections.singletonMap(instanceId, "OFFLINE"));
    String seg01Name = "testTable__0__1__" + System.currentTimeMillis();
    segmentAssignment.put(seg01Name, Collections.singletonMap(instanceId, "ONLINE"));
    String seg02Name = "testTable__0__2__" + System.currentTimeMillis();
    segmentAssignment.put(seg02Name, Collections.singletonMap(instanceId, "ONLINE"));
    // This segment is skipped as it's not from partition 0.
    String seg03Name = "testTable__1__3__" + System.currentTimeMillis();
    segmentAssignment.put(seg03Name, Collections.singletonMap(instanceId, "ONLINE"));

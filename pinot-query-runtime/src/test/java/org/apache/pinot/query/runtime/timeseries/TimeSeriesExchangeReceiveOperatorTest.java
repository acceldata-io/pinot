...
public class TimeSeriesExchangeReceiveOperatorTest {
  ...
  private static final List<String> TAG_NAMES = Arrays.asList("city", "zip");
  ...
  private List<TimeSeriesBlock> generateTimeSeriesBlocks() {
    List<TimeSeriesBlock> seriesBlocks = new ArrayList<>();
    {
      ...
      seriesMap.put(CHICAGO_SERIES_HASH, Arrays.asList(createChicagoSeries(new Double[]{10.0, 10.0, 10.0, 10.0})));
      seriesMap.put(SF_SERIES_HASH, Arrays.asList(createSanFranciscoSeries(new Double[]{10.0, 10.0, 10.0, 10.0})));

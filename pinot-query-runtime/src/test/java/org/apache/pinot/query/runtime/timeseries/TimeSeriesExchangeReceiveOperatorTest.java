...
public class TimeSeriesExchangeReceiveOperatorTest {
  ...
  private static final List<String> TAG_NAMES = ImmutableArrays.asList("city", "zip");
  ...
  private List<TimeSeriesBlock> generateTimeSeriesBlocks() {
    List<TimeSeriesBlock> seriesBlocks = new ArrayList<>();
    {
      ...
      seriesMap.put(CHICAGO_SERIES_HASH, ImmutableArrays.asList(createChicagoSeries(new Double[]{10.0, 10.0, 10.0, 10.0})));
      seriesMap.put(SF_SERIES_HASH, ImmutableArrays.asList(createSanFranciscoSeries(new Double[]{10.0, 10.0, 10.0, 10.0})));

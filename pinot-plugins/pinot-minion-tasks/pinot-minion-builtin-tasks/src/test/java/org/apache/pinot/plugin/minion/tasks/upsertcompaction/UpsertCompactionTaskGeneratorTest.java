...
public class UpsertCompactionTaskGeneratorTest {
  ...
  public void testUpsertCompactionTaskConfig() {
    Map<String, String> upsertCompactionTaskConfig =
        Collections.singletonMap("bufferTimePeriod", "5d", "invalidRecordsThresholdPercent", "1", "invalidRecordsThresholdCount",
            "1");
    UpsertConfig upsertConfig = new UpsertConfig(UpsertConfig.Mode.FULL);
    upsertConfig.setEnableSnapshot(true);
    TableConfig tableConfig = new TableConfigBuilder(TableType.REALTIME).setTableName(RAW_TABLE_NAME)
        .setUpsertConfig(upsertConfig)
        .setTaskConfig(new TableTaskConfig(Collections.singletonMap("UpsertCompactionTask", upsertCompactionTaskConfig)))
        .build();
    ...
    Map<String, String> upsertCompactionTaskConfig1 = Collections.singletonMap("invalidRecordsThresholdPercent", "0");
    TableConfig zeroPercentTableConfig = new TableConfigBuilder(TableType.REALTIME).setTableName(RAW_TABLE_NAME)
        .setUpsertConfig(upsertConfig)
        .setTaskConfig(new TableTaskConfig(Collections.singletonMap("UpsertCompactionTask", upsertCompactionTaskConfig1)))
        .build();
    ...
    Map<String, String> upsertCompactionTaskConfig2 = Collections.singletonMap("invalidRecordsThresholdPercent", "-1");
    TableConfig negativePercentTableConfig = new TableConfigBuilder(TableType.REALTIME).setTableName(RAW_TABLE_NAME)
        .setUpsertConfig(upsertConfig)
        .setTaskConfig(new TableTaskConfig(Collections.singletonMap("UpsertCompactionTask", upsertCompactionTaskConfig2)))
        .build();
    Assert.assertThrows(IllegalStateException.class,
        () -> _taskGenerator.validateTaskConfigs(negativePercentTableConfig, new Schema(),
            upsertCompactionTaskConfig2));
    Map<String, String> upsertCompactionTaskConfig3 = Collections.singletonMap("invalidRecordsThresholdPercent", "110");
    TableConfig hundredTenPercentTableConfig = new TableConfigBuilder(TableType.REALTIME).setTableName(RAW_TABLE_NAME)
        .setUpsertConfig(new UpsertConfig(UpsertConfig.Mode.FULL))
        .setTaskConfig(new TableTaskConfig(Collections.singletonMap("UpsertCompactionTask", upsertCompactionTaskConfig3)))
        .build();
    Assert.assertThrows(IllegalStateException.class,
    ...
    Map<String, String> upsertCompactionTaskConfig4 = Collections.singletonMap("invalidRecordsThresholdCount", "0");
    TableConfig invalidCountTableConfig = new TableConfigBuilder(TableType.REALTIME).setTableName(RAW_TABLE_NAME)
        .setUpsertConfig(new UpsertConfig(UpsertConfig.Mode.FULL))
        .setTaskConfig(new TableTaskConfig(Collections.singletonMap("UpsertCompactionTask", upsertCompactionTaskConfig4)))
        .build();
    Assert.assertThrows(IllegalStateException.class,
    ...
    Map<String, String> upsertCompactionTaskConfig5 = Collections.singletonMap("bufferTimePeriod", "5d");
    TableConfig invalidTableConfig = new TableConfigBuilder(TableType.REALTIME).setTableName(RAW_TABLE_NAME)
        .setUpsertConfig(new UpsertConfig(UpsertConfig.Mode.FULL))
        .setTaskConfig(new TableTaskConfig(Collections.singletonMap("UpsertCompactionTask", upsertCompactionTaskConfig5)))
        .build();
    Assert.assertThrows(IllegalStateException.class,

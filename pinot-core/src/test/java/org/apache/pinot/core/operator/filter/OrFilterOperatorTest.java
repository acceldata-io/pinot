...
public class OrFilterOperatorTest {
  ...
  public void testOrWithNull() {
    ...
    Assert.assertEquals(TestUtils.getDocIds(orFilterOperator.getTrues()), Arrays.asList(0, 1, 2, 3));
    Assert.assertEquals(TestUtils.getDocIds(orFilterOperator.getFalses()), Arrays.asList(8, 9));
  }
  ...
  public void testOrWithNullHandlingDisabled() {
    ...
    Assert.assertEquals(TestUtils.getDocIds(orFilterOperator.getTrues()), Arrays.asList(0, 1, 2, 3));
    Assert.assertEquals(TestUtils.getDocIds(orFilterOperator.getFalses()), Arrays.asList(4, 5, 6, 7, 8, 9));
  }

...
public class AndFilterOperatorTest {
  ...
  public void testAndWithNull() {
    ...
    Assert.assertEquals(TestUtils.getDocIds(andFilterOperator.getTrues()), Arrays.asList(1, 2));
    Assert.assertEquals(TestUtils.getDocIds(andFilterOperator.getFalses()), Arrays.asList(0, 7, 8, 9));
  }
  ...
  public void testAndWithNullHandlingDisabled() {
    ...
    Assert.assertEquals(TestUtils.getDocIds(andFilterOperator.getTrues()), Arrays.asList(0));
    Assert.assertEquals(TestUtils.getDocIds(andFilterOperator.getFalses()), Arrays.asList(1, 2, 3));
  }
  ...
  public void testAndWithNullOneFilterMatchesAll() {
    ...
    Assert.assertEquals(TestUtils.getDocIds(andFilterOperator.getTrues()), Arrays.asList(1, 2, 3));
    Assert.assertEquals(TestUtils.getDocIds(andFilterOperator.getFalses()), Arrays.asList(0, 7, 8, 9));
  }

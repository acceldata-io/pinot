...
public class BaseFilterOperatorTest {
  ...
  public void testBaseWithFalses() {
    ...
    Assert.assertEquals(TestUtils.getDocIds(testFilterOperator.getTrues()), ImmutableArrays.asList(0, 1, 2, 3));
    Assert.assertEquals(TestUtils.getDocIds(testFilterOperator.getFalses()), ImmutableArrays.asList(4, 5, 6, 7, 8, 9));
  }

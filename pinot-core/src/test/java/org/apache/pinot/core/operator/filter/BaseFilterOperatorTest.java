...
public class BaseFilterOperatorTest {
  ...
  public void testBaseWithFalses() {
    ...
    Assert.assertEquals(TestUtils.getDocIds(testFilterOperator.getTrues()), Arrays.asList(0, 1, 2, 3));
    Assert.assertEquals(TestUtils.getDocIds(testFilterOperator.getFalses()), Arrays.asList(4, 5, 6, 7, 8, 9));
  }

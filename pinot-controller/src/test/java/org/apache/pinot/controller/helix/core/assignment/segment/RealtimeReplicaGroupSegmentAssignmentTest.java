...
public class RealtimeReplicaGroupSegmentAssignmentTest {
  ...
  public void testRelocateCompletedSegments() {
    ...
    List<String> uploadedSegmentNames = Arrays.asList("UploadedSegment0", "UploadedSegment1", "UploadedSegment2");
  ...
  public void testAssignSegmentForUploadedSegments() {
    ...
    Map<String, List<String>> expectedUploadedSegmentToInstances = Collections.singletonMap(
        "uploadedSegment_0", Arrays.asList("completedInstance_0", "completedInstance_4", "completedInstance_8"),
        "uploadedSegment_1", Arrays.asList("completedInstance_1", "completedInstance_5", "completedInstance_9"),
        "uploadedSegment_2", Arrays.asList("completedInstance_2", "completedInstance_6", "completedInstance_10"),
        "uploadedSegment_3", Arrays.asList("completedInstance_3", "completedInstance_7", "completedInstance_11"),
        "uploadedSegment_4", Arrays.asList("completedInstance_0", "completedInstance_4", "completedInstance_8")
    );
  ...
  public void testExplicitPartition() {
    ...
    Map<InstancePartitionsType, InstancePartitions> onlyConsumingInstancePartitionMap =
        Collections.singletonMap(InstancePartitionsType.CONSUMING, consumingInstancePartitions);
    ...
    Map<InstancePartitionsType, InstancePartitions> onlyCompletedInstancePartitionMap =
        Collections.singletonMap(InstancePartitionsType.COMPLETED, completedInstancePartitions);
    ...
    Map<InstancePartitionsType, InstancePartitions> instancePartitionsMap =
        Collections.singletonMap(InstancePartitionsType.CONSUMING, consumingInstancePartitions, InstancePartitionsType.COMPLETED,

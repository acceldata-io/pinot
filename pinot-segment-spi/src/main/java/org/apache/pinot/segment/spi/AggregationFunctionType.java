...
public enum AggregationFunctionType {
  ...
  DISTINCTCOUNTHLL("distinctCountHLL", ReturnTypes.BIGINT,
      OperandTypes.family(Arrays.asList(SqlTypeFamily.ANY, SqlTypeFamily.INTEGER), i -> i == 1), SqlTypeName.OTHER),
  ...
  DISTINCTCOUNTSMARTHLL("distinctCountSmartHLL", ReturnTypes.BIGINT,
      OperandTypes.family(Arrays.asList(SqlTypeFamily.ANY, SqlTypeFamily.CHARACTER), i -> i == 1), SqlTypeName.OTHER),
  ...
  DISTINCTCOUNTCPCSKETCH("distinctCountCPCSketch", ReturnTypes.BIGINT,
      OperandTypes.family(Arrays.asList(SqlTypeFamily.ANY, SqlTypeFamily.ANY), i -> i == 1), SqlTypeName.OTHER),
  ...
  DISTINCTCOUNTHLLMV("distinctCountHLLMV", ReturnTypes.BIGINT,
      OperandTypes.family(Arrays.asList(SqlTypeFamily.ARRAY, SqlTypeFamily.INTEGER), i -> i == 1), SqlTypeName.OTHER),
